        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                ...
                <div class="block-content">
                    <form id="create-form" action="/bengkel-manager/bengkel-setting" method="POST" onsubmit="loaderOn()">
                        @csrf
        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                ...
                <div class="block-content">
                    ...
                    <form id="status-form" action="/bengkel-manager/bengkel-setting" method="POST" onsubmit="loaderOn()">
                        @method('PATCH')
                        @csrf
                        <input type="hidden" name="id">
                        <div class="form-group">
        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                ...
                <div class="block-content block-content-full text-right bg-light">
                    <form id="delete-form" action="/bengkel-manager/bengkel-setting" method="POST" onsubmit="loaderOn()">
                        @method('DELETE')
                        @csrf
                        <input type="hidden" name="id">
