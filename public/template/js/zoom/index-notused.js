...
function websdkready() {
    ...
    var API_KEY = "M9g3mWMUS5mnnmvDbwOMmA";
     ...
     */
    var API_SECRET = "vXNRQFKhSamwcPPAlu0nzjUooIUgyn7B1kcY";
        ...
        .addEventListener("click", function (e) {
            ...
            var signature = ZoomMtg.generateSignature({
                ...
                success: function (res) {
                    ...
                    var joinUrl = "/booking-status/meeting?" + testTool.serialize(meetingConfig);
                    console.log(joinUrl);
